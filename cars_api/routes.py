from cars_api import app, db, oauth
from flask import render_template, request, redirect, url_for, flash, session, jsonify

# cars_api module imports
from cars_api.forms import UserLoginForm
from cars_api.models import User, check_password_hash, Car, car_schema, cars_schema
...
from cars_api.helpers import get_jwt, token_required, verify_owner
...
def get_car(current_user_token, id):
    ...
    response = car_schema.dump(car)              #dump takes all info and shapeshifts into json string so that the web browser can read
    return jsonify(response)
